    ...
    <body>
        ...
        <form method="post" action="validFilter">
            <center>
                ...
                <tr>
                    <td>Full Name</td>
                    <td><input type="text" placeholder="Enter Name" name="uname" size="30"
                    value="<% String uname = (String) request.getParameter("uname");if (uname != null) {out.print(uname);} %>" /></td>
                    <td><%String unameMSG = (String) request.getAttribute("unameMSG"); if (unameMSG != null) { out.print(unameMSG);} %>
                    </td>
                </tr>
                <tr>
                    <td>Email</td>
                    <td><input type="text" placeholder="Enter Email ID" name="email" size="30" value="<%
                        String email = (String) request.getParameter("email"); if (email != null) {out.print(email);}%>" /></td>


                    <td><% String emailMSG1 = (String) request.getAttribute("emailMSG1"); String emailMSG2 = (String) request.getAttribute("emailMSG2");
                        if (emailMSG1 != null) {
                            out.print(emailMSG1);
                        }
                        if (emailMSG2 != null) {
                ...
                <tr>
                    ...
                    <td><input type="password"  placeholder="Enter your gmail password" name="pass" size="30" value="<%
                        String pass = (String) request.getParameter("pass"); if (pass != null) {out.print(pass);}%>" /></td>
                        <td><% String passMSG = (String) request.getAttribute("passMSG"); if (passMSG != null) { out.print(passMSG); }%>
                    </td>
                </tr>
                <tr>
